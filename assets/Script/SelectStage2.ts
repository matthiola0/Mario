...
// Apply the ccclass decorator to SelectStage2 class
@ccclass
export default class SelectStage2 extends cc.Component {
    ...
    initButtons() {
        ...
        this.initButtonEvent("Canvas/menu_bg/Level1", "stage1");
        this.initButtonEvent("Canvas/menu_bg/Level2", "stage2");
    }
    ...
    initButtonEvent(buttonPath, handler) {
        ...
        clickEventHandler.component = "SelectStage2";
        // handler
